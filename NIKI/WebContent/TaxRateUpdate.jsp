  ...
  <div class="row content">
    ...
    <div class="col-sm-8 text-left" >
		<div class="page-header">
			<h1 style="text-align: center; text-shadow: maroon;">TaxRate Update</h1>
		</div>         
    ...
    String taxV="",taxL = taxId;
        ...
        <form  action="Tax_RateResponse.jsp" method="POST">
            ...
            <table >
                 ...
                 <tr>
                    ...
                    <td>
                        <input type="text" name="taxL" value="<%=taxL%>" size="35" readonly="readonly"/> 
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="taxV" value="<%=taxV%>" required="required" size="35" >
                    </td>
