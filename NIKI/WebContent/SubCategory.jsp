<%--
    ...
    Created on : Jun 13, 2016, 10:46:30 AM
    Author     : vakaniwabo
--%>
...
session.setAttribute("subcategory",null);
...
<div class="container-fluid text-center">
  <div class="row content">
    ...
    <div class="col-sm-8 text-left" >
        ...
        <form name="inputSubCat" action="SubCategoryResponse.jsp" method="POST">
            
            
            <table id="inputSubCat" >
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="subctn" value="" required=true size="35"/> 
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="subctd" value="" required=true size="35" >
                    </td>
                    ...
                    <thead> 
                        ...
                        <%
                            ...
                            try {
                                ...
                                ResultSet rs = ST.executeQuery("SELECT * FROM niki_subcategories");
                                int i = 0;
                                while (rs.next()) {
