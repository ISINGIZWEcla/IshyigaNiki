...
<%    } else {
	...
	if(session.getAttribute("userToEdit") != null){
		username = session.getAttribute("userToEdit").toString();
	}
	else{
		username = request.getParameter("userEdit");
	}
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li><a href="FinalUsers.jsp">Final Users</a></li>
      </ul>
  ...
  <div class="row content">
    ...
    <div class="col-sm-8 text-left" >
		<div class="page-header">
			<h1 style="text-align: center; text-shadow: maroon;">User Update</h1>
		</div>         
            
		
		<%

    String eml="",psswd="",fstnm="",lstnm="",gndr="",phn="",usrtype="",privs="",usrnm = username,lang="";
                        try{
            ...
            <div id="me"> 
                ...
                <form action="UserUpdateResponse.jsp" method="POST" name="users" name="users">
                    ...
                    <table id="tb">
                        <tr>
                            ...
                            <td>UserName</td>
                            <td><input type="text" name="username" value="<%=usrnm %>" required="required" size="35" readonly="readonly">
                        ...
                        <tr>
                            ...
                            <td>
	                            <select name="usrtyp" required="required">
	                            	<option value="<%=usrtype %>"><%=usrtype %></option>
                        ...
                        <tr>
                            ...
                            <td>
                            	<select name="prvlg" multiple="multiple" required="required">
	                            	<option value="<%=privs %>"> <%=privs %> </option>
                        ...
                        <tr>
                            <td></td>
                            <td><input class="btn btn-default" type="submit" value="update" name="save" />
