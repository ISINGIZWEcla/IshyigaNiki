  ...
  <div class="row content">
    ...
    <div class="col-sm-8 text-left" >
		<div class="page-header">
			<h1 style="text-align: center; text-shadow: maroon;">Temporary Users</h1>
		</div>         
            

		<div>
                <h3>${usrtmp.insertMsg}</h3>
                <h4>${usrtmp.error} </h4>
                 
                <h3 style="background-color:buttonface">Temporary Users</h3>
                    ...
                    <thead> 
                        ...
                        <%
                            ...
                            try {
                                ...
                                ResultSet rs = ST.executeQuery("SELECT * FROM users_temp");
                                int i = 0;
                                while (rs.next()) {
                        ...
                        <tr> 
                            ...
                            <td> <%= hh%></td>
                            <td> <%= ii%></td>
                            <td> <a href="UserValidationReal.jsp?username=<%=bb%>&action=validate"> Validate </a></td>
                            <td> <a href="UserRejectSleepResponse.jsp?userRejectSleep=<%=bb%>&action=rejectTemp">Reject </a></td>
