<%-- 
    Document   : ReversedItemsCategory
    Created on : Mar 15, 2022, 1:05:50 PM
    Author     : User
--%>
...
String sql ="SELECT * FROM niki_items_temp where status='REPLACED' AND busin_category_id like '%"+business_category+"%' order by itemDesc";
...
<body>
   ...
   <div class="container data-reports">
        <div class="version">
            <div>Reversed Items FROM <%=business_category  %> BUSINESS CATEGORY</div>
        </div>
