...
<div class="container-fluid text-center">
  <div class="row content">
    ...
    <div class="col-sm-8 text-left" >
		<div class="page-header">
			<h1 style="text-align: center; text-shadow: maroon;">UNITY DOSAGE</h1>
		</div>         
        ...
        <form name="inputCat" action="DosageUnityResponse.jsp" method="POST"> 
            <table> 
            <tr>  <td> CODE </td>
            <td> <input type="text" name="niki_dose_unity_id" value="" required=true size="35"/></td>
            </tr> 
            <tr>  <td> Description: </td>
            <td> <input type="text" name="niki_dose_unity_name" value="" required=true size="35" >
            </td> </tr> 
            <tr>   <td> PHYSICAL FORM   </td>
                 <td> <select name="niki_dose_unity_physique" required="required">
 ...
 <option value="SOLID"> SOLID </option>  
        ...
        <div>
                ...
                <h3 style="background-color:buttonface">Dosage Unity List</h3>
