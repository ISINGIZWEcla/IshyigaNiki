        ...
        <div class="container-fluid text-center">
            <div class="row content">
                ...
                <div class="col-sm-8 text-left" >
                    ...
                    <form name="inputCat" class="form-horizontal"  action="FormResponse.jsp" method="POST"> 
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5">
                                    ...
                                    <input  name="niki_form_id" type="text" size="35" placeholder="Code" class="form-control input-md" required="true">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5">
                                    <input  name="niki_form_name" type="text" size="35" placeholder=" Description" class="form-control input-md" required="true">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5">
                                    <select name="niki_form_physique" class="form-control" required="required">
                            ...
                            <tbody>
                                <%
                                    ...
                                    try {
                                        ...
                                        ResultSet rs = ST.executeQuery("SELECT * FROM niki_form");
                                        int i = 0;
                                        while (rs.next()) {
