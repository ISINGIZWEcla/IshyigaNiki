...
<div id="w">
            <h3>${it_tmp.insertMsg}</h3>
                <h4>${it_tmp.error} </h4>
                <h3 style="background-color:buttonface">Transformed Items</h3>
                    ...
                    <thead> 
                        ...
                        String bus_categName="";
                            ...
                            try {
                                ...
                                ResultSet rs = ST.executeQuery("SELECT * FROM niki_items_temp where status='transformed'");
                                int i = 0;
                                while (rs.next()) {
