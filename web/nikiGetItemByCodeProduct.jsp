...
<%
    ...
    writer.close();
    if (income != null) {
String code_product=niki.Niki_request.getTagValue("CODE_PRODUCT", income);
String category=niki.Niki_request.getTagValue("BUSINESS_CATEGORY", income);
        try {


//+ "niki.niki_items_temp.niki_code= niki.niki_items.niki_code "
String sql="SELECT * FROM niki.niki_items,niki.niki_items_temp where "
+ "niki.niki_items_temp.niki_code= niki.niki_items.niki_code AND "
+ " niki.niki_items_temp.item_external_id='"+code_product+"' and busin_category_id LIKE '%"+category+"'"; 
...
%>
 <%
    ...
    while (rs.next()) {
                                    ...
                                    String niki_item_id_temp =""+rs.getInt("item_id");
         ...
         resultat +="<LINE>"
                 ...
                 + "<niki_item_id_temp>"+niki_item_id_temp+"</niki_item_id_temp>"
                 + "<item_dosage_unity>"+item_dosage_unity+"</item_dosage_unity>"
                 + "</LINE>"; 
