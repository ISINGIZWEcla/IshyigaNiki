    ...
    <div class="col-sm-8 text-left" >
		...
		<table>
		   ...
		   <tr>
					...
					<option></option>
                            ...
                            String orig="yes";
                                try {
                                    ...
                                    PreparedStatement st = conn.prepareStatement("Select companyId,companyName from niki_companies where status='LIVE'");
                                    ...
                                    while (rs.next()) {
                                        ...
                                        String compNme = rs.getString("companyName");


                            %>
                                    
                                    <option value="<%=compNme%>"><%=compNme%></option>
                            <%
			...
			<td>
				<a href="Company.jsp?origin=<%=orig %>" class="glyphicon glyphicon-plus btn btn-primary" data-toggle="modal" data-target="#basicModal">Add Company</a>
			</td>
		</tr>
		<tr>
