            ...
            <div class="row content">
                ...
                <div class="col-sm-8 text-left" >
                    <div class="page-header">
                        <h1 style=" text-align: center;background-color:orange;color: white">Validate Item <%=item_commercial_name%></h1>
                    </div>         
                    ...
                    <form id="validateItem"  "name="validateItem" action="ItemUpdateResponse.jsp" method="POST">
                        ...
                        <div class="container">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="content" pattern="[0-9]{4}" style=" font-weight: bold ">item dose: </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-12">
