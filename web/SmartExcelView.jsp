  ...
  <div class="row content">
    ...
    <div class="col-sm-8 text-left" >
		<div class="page-header">
			<h1 style="text-align: center; text-shadow: maroon;">Excel Temporary Items Matching "<%=searchItem %>"</h1>
		</div> 
                    ...
                    <thead> 
                        ...
                        String bus_categName="";
                            ...
                            try {
                                ...
                                ResultSet rs = ST.executeQuery("SELECT * FROM itemsfromexcel where description like '%"+searchItem +"%' ");
                                int i = 0;
                                while (rs.next()) {
