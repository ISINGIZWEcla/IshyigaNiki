...
String sql ="SELECT * FROM niki_items_temp where status='REJECTED' AND company_id='"+company+"' order by itemDesc";
...
<html lang="en">
<head>
  <title>Rejected Items of  <%=company  %> </title>
  <meta charset="utf-8">
...
<body>
     ...
     <nav class="navbar nav-niki">
        <div class="container-fluid links">
            ...
            <ul class="nav navbar-nav">
                ...
                <li><a class="btn btn-danger" href="RejectedItemsCategory.jsp">ALL REJECTED ITEMS FROM <%=business_category %> </a></li>
            </ul>
   ...
   <div class="container data-reports">
        <div class="version">
            <div>Rejected Items of <%=company  %></div>
        </div>
