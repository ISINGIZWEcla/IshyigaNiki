<%-- 
    Document   : RejectedItemsCategory
    Created on : Mar 15, 2022, 1:06:28 PM
    Author     : User
--%>
...
String sql ="SELECT * FROM niki_items_temp where status='REJECTED' AND busin_category_id like '%"+business_category+"%' order by itemDesc";
...
<body>
   ...
   <div class="container data-reports">
        <div class="version">
            <div>Rejected Items FROM <%=business_category  %> BUSINESS CATEGORY</div>
        </div>
