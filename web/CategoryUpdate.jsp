...
<div class="container-fluid text-center">
  <div class="row content">
    ...
    String catDesc="",cat = categId;
                        try{
                            Connection conn = ConnectionClass.getConnection();
                            Statement ST = conn.createStatement();
                            ResultSet rs = ST.executeQuery("SELECT * FROM niki_categories where category_id='"+ cat+"'");
                            int i = 0;
                            while (rs.next()) {
        ...
        <form  action="CategoryResponse.jsp" method="POST">
            ...
            <table id="updateItem" >
                 ...
                 <tr>
                    ...
                    <td>
                        <input type="text" name="cat" value="<%=cat%>" size="35" readonly="readonly"/> 
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="catDesc" value="<%=catDesc%>" required="required" size="35" >
                    </td>
