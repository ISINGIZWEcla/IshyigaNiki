  ...
  <div class="row content">
    ...
    <div class="col-sm-8 text-left" >
		<div class="page-header">
			<h1 style="text-align: center; text-shadow: maroon;">Business Category Update</h1>
		</div>         
    ...
    String buscatDesc="",busincat = buscategId;
        ...
        <form  action="Business_CategoryResponse.jsp" method="POST">
            ...
            <table >
                 ...
                 <tr>
                    ...
                    <td>
                        <input type="text" name="busincat" value="<%=busincat%>" size="35" readonly="readonly"/> 
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="buscatDesc" value="<%=buscatDesc%>" required="required" size="35" >
                    </td>
