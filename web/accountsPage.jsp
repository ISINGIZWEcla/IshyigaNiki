        ...
        <div class="container" style="min-height: 82vh">
            <div class="row">
                <div class="col-sm-8 col-sm-offset-2"> 
                    <div class="version">
                        <div>NIK-I Accounts</div>
                    </div>
                    <div class="row align-items-center">
                        <div class="col-sm-6">
                            <a href="createAccount.jsp">
                                <div id="first" class="buttonBox">
                                    <button class="niki_buttons"> <i class="fa fa-user-plus" aria-hidden="true" id="icon">&nbsp</i> CREATE USER ACCOUNT
                        ...
                        <div class="col-sm-6">
                            <a href="FinalUsers.jsp">
                                <div id="first" class="buttonBox">
                                    <button class="niki_buttons"><i class="fa fa-users" aria-hidden="true" id="icon">&nbsp</i>ALL USERS
                                    </button>
                        ...
                        <div class="col-sm-6">
                            <a href="Company.jsp">
                                <div id="first" class="buttonBox">
                                    <button class="niki_buttons"><i class="fa fa-home" aria-hidden="true" id="icon">&nbsp</i>COMPANIES
                                    </button>
                        ...
                        <div class="col-sm-6">
                            <a href="ItemExport.jsp">
                                <div id="first" class="buttonBox">
                                    <button class="niki_buttons"><i class="fa fa-building-o" aria-hidden="true" id="icon">&nbsp</i>CREATE COMPANY
                                    </button>
