            ...
            <div class="row content">
                ...
                <div class="col-sm-8 text-left" >
                    <div class="page-header">
                        <h1 style="text-align: center; text-shadow: maroon;">UPDATE ITEM <%=item_commercial_name%></h1>
                    </div>         
     ...
     <input type="text" name="niki_code" value="<%=nikicode%>" hidden="true" size="1"/>
                            ...
                            <tr>  <td bgcolor="#BCE6FB"  > item dose   </td>
                              ...
                              <tr>  <td bgcolor="#BCE6FB">   item dose unity  </td>
                                <td  bordercolor="#ff0000" > <select name="item_dosage_unity" required="required">
                                        <% try {
                                                Connection conn = ConnectionClass.getConnection();
                                                PreparedStatement st = conn.prepareStatement(
