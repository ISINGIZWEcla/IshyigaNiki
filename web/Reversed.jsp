<%-- 
    Document   : Rejected
    Created on : Mar 15, 2022, 12:14:07 PM
    Author     : Clarisse
--%>
...
String sql ="SELECT * FROM niki_items_temp where status='REPLACED' AND company_id='"+company+"' order by itemDesc";
...
<html lang="en">
<head>
  <title>Reversed Items of  <%=company  %> </title>
  <meta charset="utf-8">
...
<body>
     ...
     <nav class="navbar nav-niki">
        <div class="container-fluid links">
            ...
            <ul class="nav navbar-nav">
                ...
                <li><a class="btn btn-warning" href="ReversedItemsCategory.jsp">ALL REVERSED ITEMS FROM <%=business_category %> </a></li>
            </ul>
   ...
   <div class="container data-reports">
        <div class="version">
            <div>Reversed Items of <%=company  %></div>
        </div>
