                ...
                <div class="col-sm-8 text-left" >
                    ...
                    <div style="float: left;margin-right:20px; color: black; background: green; font-weight: bold; ">
                        <form action="Tax_Rate.jsp">
                            <input type="submit" style="width: 15em; height: 12em;color: teal" value="TAX RATES"/>
                        </form> 
                    </div>
                    <div style="float: left;margin-right:20px; color: black; background: green; font-weight: bold; ">
                        <form action="Hs_Code.jsp">
                            <input type="submit" style="width: 15em; height: 12em;color: teal" value="HS CODE"/>
                        </form> 
                    </div>
