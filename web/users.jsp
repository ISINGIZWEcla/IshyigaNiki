  ...
  <div class="row content">
    ...
    <div class="col-sm-8 text-left" >
		<div class="page-header">
			<h1 style="text-align: center; text-shadow: maroon;">NIK-I Users</h1>
		</div>         
            
 

        <div style="float: left;margin-right:20px">
        	<form action="TempUsers.jsp">
        		<input type="submit" style="width: 15em; height: 12em;color: black; background: green ; font-weight: bold;" value="PENDING USERS"/>
        	</form> 
        </div>
        <div style="float: left;margin-right:20px">
        	<form action="FinalUsers.jsp">
        		<input type="submit" style="width: 15em; height: 12em;color: black; background: orange ; font-weight: bold;" value="FINAL USERS"/>
        	</form> 
        </div>
