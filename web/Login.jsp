...
<body>
    <div class="login-form">
        ...
        <form method="post" action="LoginResponse.jsp">
            <p class="text-center">
                <a class="text-center" href="niki.jsp"><img src="assets/images/final.png" alt="" width="200"></a></br>
                Welcome to NIKI, Please login to continue.
           
            </p>
            <!--<a class="text-center" href="niki.jsp"><img src="assets/NIKI.png" alt="" width="70"></a>-->
