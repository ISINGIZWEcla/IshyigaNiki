...
if(session.getAttribute("fromChooseCompany")!=null){
    ...
    String niki_form_id = request.getParameter("niki_form_id").toUpperCase().replaceAll("'", " ");
    
    String niki_form_name = request.getParameter("niki_form_name").toUpperCase().replaceAll("'", " ");
String niki_form_physique = request.getParameter("niki_form_physique").toUpperCase().replaceAll("'", " ");
