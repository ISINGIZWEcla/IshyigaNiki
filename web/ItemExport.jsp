...
<%    String item_cat = "RETAIL PHARMACY";
    String codeb = null;
    String itmDesc = null, itmcat = null, fabricant = null, itemDescr = null, itmcatN = null;
...
<html lang="en">
    ...
    <body>
        ...
        <div class="container-fluid text-center">
            <div class="row content">
                ...
                <div class="col-sm-8 text-left" >
                    ...
                    <form name="inputItem" action="ItemExport.jsp?" method="POST">
                        ...
                        <br><br>
                        <div class="col-sm-12">
                            <div class="col-sm-6"> <select  name="business_cat"  class="form-control"  required="required">
                                    <option class="form-control" value=""> SELECT BUSINESS CATEGORY</option>
                                    <%
                                        try {
            ...
            <div id="w">
                <h3 style="text-align: center; text-shadow: maroon;background-color: orange; color:white">NIKI Items for <%=item_cat%> List 
                </h3>
